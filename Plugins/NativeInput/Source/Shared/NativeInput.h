...
namespace Babylon::Plugins
{
    ...
    public:
        ...
        void MouseWheel(uint32_t wheelAxis, uint32_t scrollValue);
    ...
    private:
        ...
        void PointerScroll(uint32_t pointerId, uint32_t scrollAxis, uint32_t scrollValue, DeviceType deviceType);
